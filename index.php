  ...
  <body>
    ...
    <section class="hero">
      ...
      <div class="container">
        ...
        <p>
          Profesional, cepat, dan siap memberikan solusi terbaik untuk kebutuhan truk bisnis Anda. Layanan responsif, proses mudah, dan harga kompetitif!
        </p>
        <a
    ...
    <div class="about-content">
      <div class="text">
        ...
        <div class="contact-buttons">
          <a href="https://wa.me/6285975287684" class="btn whatsapp-btn">
            <i class="fab fa-whatsapp"></i> +62 859-7528-7684
          </a>
          <a href="mailto:saleshinojabodetabek@gmail.com" class="btn email-btn">
            <i class="fas fa-envelope"></i> saleshinojabodetabek@gmail.com
          </a>
        </div>
      </div>
  ...
  <div class="carousel-wrapper">
    ...
    <div class="carousel">
      <div class="product-item">
        <a href="hino300.html">
          <img src="img/300series/136MDL.png" alt="Undercarriage" />
          <p><strong>Hino 300 Series</strong></p>
        </a>
      </div>

      <div class="product-item">
        <a href="hino500.html">
          <img src="img/500series/FM340TH.png" alt="Hardware" />
          <p><strong>Hino 500 Series</strong></p>
        </a>
      </div>

      <div class="product-item">
        <a href="hinobus.html">
          <img src="img/hinobus.png" alt="Chassis" />
          <p><strong>Hino Bus Series</strong></p>
        </a>
      </div>
    </div>
      ...
      <div class="contact-info">
        ...
        <div class="contact-item">
          ...
          <div>
            ...
            saleshinojabodetabek@gmail.com
          </div>
        </div>
      </div>
    </div>
